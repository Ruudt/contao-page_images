...
$GLOBALS['TL_LANG']['tl_module']['pageimages'] = array('Page image category', 'Please choose the page image category');
...
$GLOBALS['TL_LANG']['tl_module']['pageimages_type'] = array('Nr of images', 'Choose the nr of images to display or 0 for all selected images.');
